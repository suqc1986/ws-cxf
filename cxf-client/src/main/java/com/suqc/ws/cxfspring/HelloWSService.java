 ...
 * 
 */
@WebServiceClient(name = "HelloWSService", targetNamespace = "http://service.ws.suqc.com/hello", wsdlLocation = "http://localhost:8080/cxfdemo/ws/hellows?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSSERVICE_QNAME = new QName("http://service.ws.suqc.com/hello", "HelloWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/cxfdemo/ws/hellows?wsdl");
    ...
    public HelloWS getHelloWSPort() {
        return super.getPort(new QName("http://service.ws.suqc.com/hello", "HelloWSPort"), HelloWS.class);
    }
    ...
    public HelloWS getHelloWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ws.suqc.com/hello", "HelloWSPort"), HelloWS.class, features);
    }
