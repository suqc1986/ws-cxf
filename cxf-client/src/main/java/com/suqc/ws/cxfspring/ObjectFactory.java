 ...
 * generated in the com.suqc.ws.cxfspring package. 
...
public class ObjectFactory {
    ...
    private final static QName _Welcome_QNAME = new QName("http://service.ws.suqc.com/hello", "welcome");
    private final static QName _WelcomeResponse_QNAME = new QName("http://service.ws.suqc.com/hello", "welcomeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.suqc.ws.cxfspring
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.suqc.com/hello", name = "welcome")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.suqc.com/hello", name = "welcomeResponse")
