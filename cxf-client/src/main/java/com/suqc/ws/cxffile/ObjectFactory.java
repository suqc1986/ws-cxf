 ...
 * generated in the com.suqc.ws.cxffile package. 
...
public class ObjectFactory {
    ...
    private final static QName _UploadResponse_QNAME = new QName("http://impl.service.ws.suqc.com/file", "uploadResponse");
    private final static QName _Upload_QNAME = new QName("http://impl.service.ws.suqc.com/file", "upload");
    private final static QName _DownloadResponse_QNAME = new QName("http://impl.service.ws.suqc.com/file", "downloadResponse");
    private final static QName _Download_QNAME = new QName("http://impl.service.ws.suqc.com/file", "download");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.suqc.ws.cxffile
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.ws.suqc.com/file", name = "uploadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.ws.suqc.com/file", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.ws.suqc.com/file", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.ws.suqc.com/file", name = "download")
